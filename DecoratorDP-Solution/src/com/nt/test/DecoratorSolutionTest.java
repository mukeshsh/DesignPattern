...
import com.nt.component.SavingBankAccount;
import com.nt.decorator.CreditCardDecorator;
import com.nt.decorator.GoldenBankAccountDecorator;
...
public class DecoratorSolutionTest {
	...
	public static void main(String[] args) {
     ...
     account1= new NRIBankAccountDecorator(new CreditCardDecorator(new GoldenBankAccountDecorator(new SavingBankAccount())));
