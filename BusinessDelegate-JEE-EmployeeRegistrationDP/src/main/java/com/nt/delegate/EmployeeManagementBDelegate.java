...
import com.nt.bo.FinanaceEmployeeBO;
...
public class EmployeeManagementBDelegate {
	private HREmployeeDAO dao1=null;
    private  FinanceEmployeeDAO dao2=null;
    private static Logger logger=Logger.getLogger(EmployeeManagementBDelegate.class);
	...
	public EmployeeManagementBDelegate() {
	...
	public    String  regsiterEmployee(EmployeeVO vo)throws EmployeeRegistrationProblem{
		   ...
		   FinanaceEmployeeBO financeBO=null;
		   Connection con=null;
		   boolean flag=false;
		   String msg=null;
		   try {
			   ...
			   financeBO=new FinanaceEmployeeBO();
