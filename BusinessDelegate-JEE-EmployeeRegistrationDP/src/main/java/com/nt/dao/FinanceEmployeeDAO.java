...
public class FinanceEmployeeDAO implements EmployeeDAO {
    private static final String INSERT_FINANCE_EMP_QUERY="INSERT INTO BD_FINANCE_EMP VALUES(DP_SEQ.CURRVAL,?,?,?)";
	...
	public void insert(BaseEmployeeBO bo, Connection con) throws SQLException {
      ...
      try {
    	  ...
    	  logger.debug("prepared statement object created");
    	  //set values to query params
    	  ps.setString(1, bo.getEname());
    	  ps.setString(2, bo.getEadd());
    	  ps.setFloat(3,((FinanaceEmployeeBO)bo).getSalary());
